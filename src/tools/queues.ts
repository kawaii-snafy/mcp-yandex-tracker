...
organization instead.`,
    ...
    run: (tracker, a) =>
      tracker.request("GET", `/queues/${a.queueId}`, { params: given({ expand: a.expand }) }),
  }),
...
https://yandex.ru/support/tracker/en/api/queues/delete-queue.md`,
    ...
    run: (tracker, a) => tracker.request("DELETE", `/queues/${a.queueId}`),
  }),
...
Only an organization administrator can make this request.`,
    ...
    run: (tracker, a) => tracker.request("POST", `/queues/${a.queueId}/_restore`),
  }),
...
https://yandex.ru/support/tracker/en/api/queues/get-fields.md`,
    ...
    run: (tracker, a) => tracker.request("GET", `/queues/${a.queueId}/fields`),
  }),
...
https://yandex.ru/support/tracker/en/api/queues/get-versions.md`,
    ...
    run: (tracker, a) => tracker.request("GET", `/queues/${a.queueId}/versions`),
  }),
...
https://yandex.ru/support/tracker/en/api/queues/get-tags.md`,
    ...
    run: (tracker, a) => tracker.request("GET", `/queues/${a.queueId}/tags`),
  }),
...
not used in any issue of the queue.`,
    ...
    run: (tracker, a) =>
      tracker.request("POST", `/queues/${a.queueId}/tags/_remove`, {
...
Specify at least one of the four permission fields.`,
    ...
    run: (tracker, a) =>
      tracker.request("PATCH", `/queues/${a.queueId}/permissions`, {
...
https://yandex.ru/support/tracker/en/api/queues/get-user-access.md`,
    ...
    run: (tracker, a) =>
      tracker.request("GET", `/queues/${a.queueId}/permissions/users/${a.userId}`),
  }),
...
https://yandex.ru/support/tracker/en/api/queues/get-group-access.md`,
    ...
    run: (tracker, a) =>
      tracker.request("GET", `/queues/${a.queueId}/permissions/groups/${a.groupId}`),
  }),
...
https://yandex.ru/support/tracker/en/api/queues/create-local-field.md`,
    ...
    run: (tracker, a) =>
      tracker.request("POST", `/queues/${a.queueId}/localFields`, {
        body: given({
          name: a.name,
          id: a.id,
          category: a.category,
...
https://yandex.ru/support/tracker/en/api/queues/get-local-fields.md`,
    ...
    run: (tracker, a) => tracker.request("GET", `/queues/${a.queueId}/localFields`),
  }),
...
https://yandex.ru/support/tracker/en/api/queues/get-info-local-field.md`,
    ...
    run: (tracker, a) => tracker.request("GET", `/queues/${a.queueId}/localFields/${a.fieldKey}`),
  }),
...
https://yandex.ru/support/tracker/en/api/queues/edit-local-field.md`,
    ...
    run: (tracker, a) =>
      tracker.request("PATCH", `/queues/${a.queueId}/localFields/${a.fieldKey}`, {
        body: given({
          name: a.name,
          category: a.category,
          order: a.order,
...
https://yandex.ru/support/tracker/en/api/queues/workflows/get-workflow.md`,
    ...
    run: (tracker, a) => tracker.request("GET", `/workflows/${a.workflowId}`),
  }),
...
Send only the parameters you want to change.`,
    ...
    run: (tracker, a) =>
      tracker.request("PATCH", `/workflows/${a.workflowId}`, {
...
https://yandex.ru/support/tracker/en/api/queues/workflows/patch-workflow-action.md`,
    ...
    run: (tracker, a) =>
      tracker.request(
        "PATCH",
        `/workflows/${a.workflowId}/steps/${a.status}/actions/${a.actionId}`,
        {
          params: given({ version: a.version }),
          body: given({
            id: a.id,
...
https://yandex.ru/support/tracker/en/api/queues/workflows/delete-workflow.md`,
    ...
    run: (tracker, a) => tracker.request("DELETE", `/workflows/${a.workflowId}`),
  }),
...
https://yandex.ru/support/tracker/en/api/queues/create-autoaction.md`,
    ...
    run: (tracker, a) =>
      tracker.request("POST", `/queues/${a.queueId}/autoactions`, {
        body: given({
          name: a.name,
          actions: a.actions,
          filter: a.filter,
...
https://yandex.ru/support/tracker/en/api/queues/get-autoaction.md`,
    ...
    run: (tracker, a) =>
      tracker.request("GET", `/queues/${a.queueId}/autoactions/${a.autoactionId}`),
  }),
...
Each entry carries the run \`id\` to pass to tracker_get_autoaction_run_log.`,
    ...
    run: (tracker, a) =>
      tracker.request("GET", `/queues/${a.queueId}/autoactions/${a.autoactionId}/logs`),
  }),
...
https://yandex.ru/support/tracker/en/api/queues/view-autoaction-logs.md`,
    ...
    run: (tracker, a) =>
      tracker.request("GET", `/queues/${a.queueId}/autoactions/${a.autoactionId}/logs/${a.runId}`),
  }),
...
https://yandex.ru/support/tracker/en/api/queues/create-trigger.md`,
    ...
    run: (tracker, a) =>
      tracker.request("POST", `/queues/${a.queueId}/triggers`, {
        body: given({
          name: a.name,
          actions: a.actions,
          conditions: a.conditions,
...
next one.`,
    ...
    run: (tracker, a) =>
      tracker.request("GET", `/queues/${a.queueId}/triggers`, {
...
https://yandex.ru/support/tracker/en/api/queues/get-trigger.md`,
    ...
    run: (tracker, a) => tracker.request("GET", `/queues/${a.queueId}/triggers/${a.triggerId}`),
  }),
...
https://yandex.ru/support/tracker/en/api/queues/change-trigger.md`,
    ...
    run: (tracker, a) =>
      tracker.request("PATCH", `/queues/${a.queueId}/triggers/${a.triggerId}`, {
        params: given({ version: a.version }),
        body: given({
          name: a.name,
          actions: a.actions,
...
https://yandex.ru/support/tracker/en/api/queues/view-trigger-logs.md`,
    ...
    run: (tracker, a) =>
      tracker.request("GET", `/queues/${a.queueId}/triggers/${a.triggerId}/webhooks/log`, {
...
https://yandex.ru/support/tracker/en/api/queues/patch-component.md`,
    ...
    run: (tracker, a) =>
      tracker.request("PATCH", `/components/${a.componentId}`, {
        params: given({ version: a.version }),
        body: given({
          name: a.name,
          description: a.description,
...
https://yandex.ru/support/tracker/en/api/queues/get-component-user-access.md`,
    ...
    run: (tracker, a) =>
      tracker.request("GET", `/components/${a.componentId}/permissions/users/${a.userId}`),
  }),
...
https://yandex.ru/support/tracker/en/api/queues/get-component-group-access.md`,
    ...
    run: (tracker, a) =>
      tracker.request("GET", `/components/${a.componentId}/permissions/groups/${a.groupId}`),
  }),
];
